...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "MEMMAL_v1.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'MEMMAL_v1._MEMMAL_v1',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'MEMMAL_v1',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model MEMMAL_v1',
